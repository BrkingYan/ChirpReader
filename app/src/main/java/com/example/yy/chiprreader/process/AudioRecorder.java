package com.example.yy.chiprreader.process;
...
public class AudioRecorder implements IAudioRecorder{
    ...
    public AudioRecorder(int samplingRate){
        ...
        new Thread(new PriorityRunnable(Process.THREAD_PRIORITY_AUDIO) {
            ...
            public void runImpl() {
                ...
                int bufferSize = Math.max(BUFFER_BYTES_ELEMENTS * BUFFER_BYTES_PER_ELEMENT,
                        AudioRecord.getMinBufferSize(samplingRate, RECORDER_CHANNELS_IN, RECORDER_AUDIO_ENCODING));
                ...
                AudioRecord recorder = new AudioRecord(MediaRecorder.AudioSource.MIC, samplingRate, RECORDER_CHANNELS_IN, RECORDER_AUDIO_ENCODING, bufferSize);
